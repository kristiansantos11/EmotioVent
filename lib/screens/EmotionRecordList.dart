...
class EmotionRecordList extends StatefulWidget {
  @override
  _EmotionRecordListState createState() => _EmotionRecordListState();
}

class _EmotionRecordListState extends State<EmotionRecordList> {
  @override
